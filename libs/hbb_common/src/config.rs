...
pub const RENDEZVOUS_SERVERS: &[&str] = &["szppp.iask.in"];
pub const PUBLIC_RS_PUB_KEY: &str = "KJxQTiAmAqnAEK42isjP7UI1eRQTjoOZeiLpBFPQETc=";
pub const API_SERVER: &[&str] = &["http://szppp.iask.in:21114"];
